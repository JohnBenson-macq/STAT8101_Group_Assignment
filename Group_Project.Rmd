...
- **Non-response**: 
A variety of different forms of non-response occurs within this survey as a result of the questions compositon, distribution methods and respondant locations. 
- Non-reposnese based on branching or skip-logic. Many questions are skipped based on the respodants answers to previous questions. This is done to streamline the survey, improve the relevance of questions and increase the specifc information gathed on respondants. For example, job focused questions would only be visible to those who resposnded that they had a job, therfore resulting in non-resposne for all branching questions. 
- Non-reposnese based on failure to respond when contacted ???
- unable to asnwer ?? was it sent out in other languaes or just english ?

How does the survey deﬁne nonresponse rate, and what are the nonresponse rates for the survey? 

What methods are used to try to adjust for the nonresponse?
